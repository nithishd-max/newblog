    ...
    <section className="resume-section" id="about">
                <div className="resume-section-content">
                    ...
                    <div className="social-icons">
                        <a className="social-icon" href="https://www.linkedin.cn/in/nithish-reddy-213634156/"><i className="fab fa-linkedin-in"></i></a>
                        <a className="social-icon" href="https://github.com/nithishd-max"><i className="fab fa-github"></i></a>
                        <a className="social-icon" href="https://www.instagram.com/nithish_reddy.devireddy/"><i className="fab fa-instagram"></i></a>
